...
<body>
    ...
    <div class="smit-image">
        <img src="images/smitimg.jpg"id="img">
</div>
<br/>
 <div class="container d-flex" style="justify-content:center">
    ...
    <p><b>"<i>Welcome to the department of ECE student council.We believe in winning.</i>"</b></p>
</div>
 <div class="container d-flex"style="justify-content:center;padding:30px;font-family: 'Montserrat', sans-serif;padding:34px;">
            <h1 style="font-size:calc(5vw);opacity:90%;">COUNCIL MEMBERS</h1>
        </div>
...
<table class="table table-striped">
 <thead>
  ...
  $sql = "SELECT post,regnum,name FROM student";
